...
function Invitation() {
  ...
  return (
    <div className={cx("wrapper")}>
      ...
      <Days title="Tháng 3" activeDay={invitationSection.activeDay}/>
      {/* <Infomation
        img={wed1Info.img}
        title={wed1Info.title}
        date={wed1Info.date}
        time={wed1Info.time}
        address={wed1Info.address}
        street={wed1Info.street}
        phone={wed1Info.phone}
        posision={wed1Info.posision}
      /> */}
      <Infomation
        img={wedInfo.img}
        title={wedInfo.title}
